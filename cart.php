                                    ...
                                    foreach ($_SESSION['cart'] as $key => $val) {
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img
                                                        src="<?php echo PRODUCT_IMAGE_SITE_PATH . $image ?>" width="550px"
                                                        height="140px" /></a></td>
                                            <td class="product-name"><a href="#"><?php echo $pname ?></a></td>
                                            <td class="product-price"><span class="amount">Rs.<?php echo $price ?></span>
                                            </td>
                                            <td class="product-quantity"><input type="number" id="<?php echo $key ?>qty"
                                                    value="<?php echo $qty ?>" /><br><br /><a
                                                    href="javascript:void(0)"
                                                    onclick="manage_cart('<?php echo $key ?>','update')">Update</a>
                                            </td>
                                            
                                            <td class="product-subtotal">Rs.<?php echo number_format((float)$qty * (float)$price, 2, '.', '') ?></td>
